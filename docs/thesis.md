...
в окружении, которое соответствует спецификации контейнер. Всё это runc делает
...
## Режим бинда
В данном случае (листинг 6) можно видеть, как была смонтирована только рабочяя
