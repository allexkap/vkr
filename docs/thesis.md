...
зависимостей, политик безопасности и доступа. [1]
...
- awesome-linux-containers – Подборка фреймворков, библиотек и программного
  обеспечения для Linux-контейнеров; [2]
- awesome-containers – Подборка технологий, связанных с Linux-контейнерами,
  вдохновленная другими «Awesome» списками; [3]
- Open Repository for Container Tools – Коллекция инструментов с открытым
  исходным кодом для создания, настройки и работы с контейнерами. [4]
...
процессом запуска контейнеров. [5]
...
интеграцией контейнера с хост-системой. [6]
...
делает систему более предсказуемой. [7]
...
медленнее, требовательнее, сложнее в отладке. [8]
...
ошибок, вроде утечек памяти или гонок данных. [9][10][11]
...
ориентирован в первую очередь на переносимость. [12]
...
(например, браузеров, медиаплееров или офисных приложений). [13]
...
видит свою «копию» этих ресурсов, не влияющую на остальную систему. [15]
...
к какому-то ресурсу, без системного вызова он не сможет им воспользоваться. [17]
...
если такой доступ не прописан явно. [18]
...
запускать без повышенных прав. [20]
...
местах, с разными правами и даже под разными именами. [21]
...
логов, и для отладки, и просто для визуального разделения сред. [22]
...
пространства имен, но и также даже не знать о их существовании. [23]
...
делается независимо от основной системы. [24]
...
на друга (использовать одни и те же участки общей памяти и т. д.). [25]
...
Разработка механизма изоляции «с нуля» – через прямое использование clone [26],
unshare [27] и других системных вызовов – дает высокий уровень контроля, так как
...
<div align="center">
<img src="./images/re.png" width=50%>
...
библиотек на целевой системе. [34]
