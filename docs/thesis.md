...
основной файловой системы для доступа к её содержимому  
**Оркестрация** – координация и контроль жизненного цикла компонентов приложений
в распределённой среде с учётом зависимостей, масштабирования и
отказоустойчивости  
...
dockerfile, сборку, загрузку и хранение слоёв, что делает его избыточным для
