...
пространствами имен, cgroups и mount-системами, реализуя минимальный необходимый
...
надежную, легко сопровождаемую и безопасную альтернативу существующим рантаймам.
...
учет ресурсов в многопользовательских системах или изоляция сетевых стеков – но
